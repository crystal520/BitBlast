...
- (id) initWithTitle:(NSString*)title text:(NSString*)text buttons:(NSString*)buttons target:(id)t selector:(SEL)s {
	...
	// create text
	CCLabelBMFont *textLabel = [CCLabelBMFont labelWithString:text fntFile:@"gamefont.fnt" width:1228 * [ResolutionManager sharedSingleton].positionScale alignment:kCCTextAlignmentCenter];
	textLabel.scale = 0.4;
