...
- (void) gotoLeaderboards {
	...
	if(leaderboardController) {
		...
		[[Globals getAppViewController] presentModalViewController:leaderboardController animated:YES];
	}
...
- (void) gotoAchievements {
	...
	if(achievementController) {
		...
		[[Globals getAppViewController] presentModalViewController:achievementController animated:YES];
	}
...
- (void) leaderboardViewControllerDidFinish:(GKLeaderboardViewController *)viewController {
	[[Globals getAppViewController] dismissModalViewControllerAnimated:YES];
}
